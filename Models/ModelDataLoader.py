...
class ModelDataLoader:
    def __init__(self, start_date_data, end_date_data, start_data_cohort, end_data_cohort,
                 ...
                 ctrl_var=None, ctrl_var_value=None, balance_classes_early=True):
        ...
        self.balance_classes_early = balance_classes_early
        self.load_data()
    ...
    def load_real_data(self):
        self.data_processing.process_all(self.ctrl_var, self.ctrl_var_value, self.balance_classes_early)
